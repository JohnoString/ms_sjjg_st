...
// required int32 id = 1;
inline bool Hello::_internal_has_id() const {
...
inline ::PROTOBUF_NAMESPACE_ID::int32 Hello::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 Hello::id() const {
  // @@protoc_insertion_point(field_get:hello.Hello.id)
  return _internal_id();
}
inline void Hello::_internal_set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _has_bits_[0] |= 0x00000004u;
  id_ = value;
}
inline void Hello::set_id(::PROTOBUF_NAMESPACE_ID::int32 value) {
...
// optional string email = 3;
inline bool Hello::_internal_has_email() const {
...
inline const std::string& Hello::_internal_email() const {
  return email_.Get();
}
inline void Hello::_internal_set_email(const std::string& value) {
  _has_bits_[0] |= 0x00000002u;
  email_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void Hello::set_email(std::string&& value) {
  _has_bits_[0] |= 0x00000002u;
  email_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:hello.Hello.email)
}
...
inline std::string* Hello::_internal_mutable_email() {
  _has_bits_[0] |= 0x00000002u;
  return email_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* Hello::release_email() {
  // @@protoc_insertion_point(field_release:hello.Hello.email)
